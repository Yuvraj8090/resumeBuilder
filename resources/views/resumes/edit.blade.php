<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <span class="text-sm text-slate-500 font-normal">
                Last updated: {{ $resume->updated_at->diffForHumans() }}
            </span>
        </div>
    </x-slot>
    ...
    <div class="py-12" x-data="resumeWizard()">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('resumes.update', $resume->id) }}" method="POST" class="bg-white/80 backdrop-blur-xl border border-white/50 shadow-xl rounded-3xl overflow-hidden">
                @csrf
                @method('PUT')
                    ...
                    <div class="p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-2">
                                ...
                                <input type="text" name="title" value="{{ old('title', $resume->title) }}" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 transition shadow-sm">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1">Full Name</label>
                                <input type="text" name="full_name" value="{{ old('full_name', $resume->full_name) }}" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 transition shadow-sm">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1">Email</label>
                                <input type="email" name="email" value="{{ old('email', $resume->email) }}" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 transition shadow-sm">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1">Phone</label>
                                <input type="tel" name="phone" value="{{ old('phone', $resume->phone) }}" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 transition shadow-sm">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1">LinkedIn / Website</label>
                                <input type="url" name="linkedin_url" value="{{ old('linkedin_url', $resume->linkedin_url) }}" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 transition shadow-sm">
                            </div>

                            <div class="col-span-2">
                                <label class="block text-sm font-medium text-slate-700 mb-1">Professional Summary</label>
                                <div class="relative">
                                    <textarea x-model="summary" name="summary" rows="4" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 transition shadow-sm"></textarea>
                            ...
                            <div class="mb-6 bg-white p-6 rounded-2xl shadow-sm border border-slate-200 relative group hover:border-indigo-300 transition">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input type="text" :name="'experiences['+index+'][job_title]'" :value="experience.job_title" placeholder="e.g. Senior Developer" class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-bold text-slate-500 uppercase mb-1">Employer</label>
                                        <input type="text" :name="'experiences['+index+'][employer]'" :value="experience.employer" placeholder="e.g. Acme Corp" class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-bold text-slate-500 uppercase mb-1">Start Date</label>
                                        <input type="date" :name="'experiences['+index+'][start_date]'" :value="formatDate(experience.start_date)" class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm text-slate-500">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-bold text-slate-500 uppercase mb-1">End Date</label>
                                        <input type="date" :name="'experiences['+index+'][end_date]'" :value="formatDate(experience.end_date)" class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm text-slate-500">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <textarea x-model="experiences[index].description" :name="'experiences['+index+'][description]'" rows="3" class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="• Led a team..."></textarea>
                                        ...
                                        <button type="button" 
                                            ...
                                            <svg x-show="experiences[index].isRewriting" class="animate-spin h-4 w-4 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-6 bg-white p-6 rounded-2xl shadow-sm border border-slate-200 relative group hover:border-indigo-300 transition">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" :name="'education['+index+'][institution]'" :value="edu.institution" class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-bold text-slate-500 uppercase mb-1">Degree / Certificate</label>
                                        <input type="text" :name="'education['+index+'][degree]'" :value="edu.degree" class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-bold text-slate-500 uppercase mb-1">City</label>
                                        <input type="text" :name="'education['+index+'][city]'" :value="edu.city" class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-bold text-slate-500 uppercase mb-1">Completion Date</label>
                                        <input type="date" :name="'education['+index+'][end_date]'" :value="formatDate(edu.end_date)" class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm text-slate-500">
                                    </div>
                                </div>
                            </div>
                        </template>
                ...
                <div x-show="step === 4" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0" style="display: none;">
                    <div class="p-8">
                        ...
                        <div class="bg-indigo-50 p-4 rounded-xl mb-6 text-indigo-800 text-sm">
                            <p><strong>Tip:</strong> Keep skills updated with your latest technologies.</p>
                        </div>

                        <div class="space-y-3 mb-8">
                            <template x-for="(skill, index) in skills" :key="skill.id">
                                <div class="flex gap-3">
                                    <input type="text" :name="'skills['+index+'][name]'" :value="skill.name" placeholder="e.g. Python" class="flex-1 rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500">
                                    
                                    <select :name="'skills['+index+'][level]'" :value="skill.level" class="rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-slate-600">
                ...
                <div class="bg-slate-50 px-8 py-5 border-t border-slate-200 flex justify-between items-center">
                    ...
                    <button type="submit" x-show="step === 4" class="px-8 py-2.5 rounded-xl bg-indigo-600 text-white font-bold shadow-lg shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-0.5 transition transform flex items-center gap-2" style="display: none;">
                        <i data-lucide="save" class="w-4 h-4"></i> Update Resume
                    </button>
                </div>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('resumeWizard', () => ({
                ...
                // Initialize Summary from DB
                summary: @json(old('summary', $resume->summary ?? '')),
                isRewritingSummary: false,
                
                // Initialize Relations: Use existing DB data OR fallback to one empty item if empty
                // We add 'isRewriting: false' to experiences for the UI state
                experiences: @json($resume->experiences->isNotEmpty() 
                    ? $resume->experiences->map(function($item) { $item['isRewriting'] = false; return $item; }) 
                    : [['id' => 'new_'.uniqid(), 'description' => '', 'isRewriting' => false]]
                ),

                education: @json($resume->education->isNotEmpty() 
                    ? $resume->education 
                    : [['id' => 'new_'.uniqid()]]
                ),

                skills: @json($resume->skills->isNotEmpty() 
                    ? $resume->skills 
                    : [['id' => 'new_'.uniqid()], ['id' => 'new_'.uniqid()+1]]
                ),

                // Helper to format dates YYYY-MM-DD for input[type=date]
                formatDate(dateString) {
                    if (!dateString) return '';
                    return dateString.split('T')[0]; // Handles "2023-01-01T00:00:00.000000Z"
                },

                // --- Experience Functions ---
                addExperience() {
                    this.experiences.push({ id: 'new_' + Date.now(), description: '', isRewriting: false });
                ...
                async rewriteExperience(index) {
                    ...
                    try {
                        ...
                        if (data.content) this.experiences[index].description = data.content;
                    } catch (error) {
                ...
                async rewriteSummary() {
                    ...
                    try {
                        ...
                        const data = await response.json();
                        if (data.content) this.summary = data.content;
                    } catch (error) {
                        alert('Connection failed.');
                    } finally {
                ...
                // --- Education Functions ---
                addEducation() {
                    this.education.push({ id: 'new_' + Date.now() });
                    this.$nextTick(() => lucide.createIcons());
                },
                ...
                // --- Skill Functions ---
                addSkill() {
                    this.skills.push({ id: 'new_' + Date.now() });
                    this.$nextTick(() => lucide.createIcons());
                },
                removeSkill(index) {
